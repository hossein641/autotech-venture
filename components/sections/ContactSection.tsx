...
import { Phone, Mail, MapPin, Clock, MessageSquare, ArrowRight, CheckCircle, Loader2, X, AlertCircle } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
              ...
              {contactMethods.map((method, index) => {
                ...
                return (
                  <div key={index} className="flex items-start">
                    <div className="inline-flex p-3 rounded-lg bg-emerald-100 text-emerald-600 mr-4">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-4">Why Choose AutoTech Venture?</h3>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-emerald-600 text-white py-3 rounded-lg hover:bg-emerald-700 transition-colors font-semibold flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
                  <>
